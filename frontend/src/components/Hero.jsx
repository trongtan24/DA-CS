            ...
            <div className="w-full h-full flex items-center justify-center bg-gray-100">
              ...
              {slider.video && (
                <div className="relative w-full h-full group">
                  ...
                  <ScrollToTop
                    to={`/shop/${slider.to}`}
                    className="absolute top-4 right-4 z-10 bg-black/70 text-white hover:bg-white hover:text-black px-4 py-2 rounded-full transition-all duration-300 group-hover:flex mdlg:hidden mdlg:group-hover:flex items-center gap-2"
                  >
                    Mua ngay
                  </ScrollToTop>
                </div>
