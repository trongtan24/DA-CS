...
function loginForm({ switchToRegister }: LoginFormProps) {
  return (
    <>
        ...
        <p className="text-center mt-4 flex flex-row justify-center gap-4 items-center ml-4 mr-4 text-nowrap">
            Đã có tài khoản?
            <button type="button" className="bg-blue-500 text-white rounded-4xl p-2 pl-4 pr-4 text-nowrap transition hover:bg-indigo-600 cursor-pointer max-w-[120px] w-full" onClick={switchToRegister}>
                Đăng ký
            </button>
        </p>
    </>
