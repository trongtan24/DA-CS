    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
        ...
        <div className="flex md:pl-64 xl:pr-16 items-center justify-between gap-4 p-2">
          ...
          <div className='flex-1 w-max mx-4 hidden-520 block md:hidden'>
            {combineSearchBar}
          </div>
        ...
        {/* Bottom bar*/}
        <div className="border-b xl:pl-86 border-gray-300 bg-white p-2 flex items-center md:justify-between z-50 xl:pr-12">
          ...
          {/* Address */}
          <div className='text-gray-500 text-md break-words line-clamp-2 md:block hidden ml-60 lg:ml-72 xl:ml-0 md:-pl-32'>
            <strong className=''>Địa chỉ:</strong> 123 Đường ABC, Quận XYZ, TP. HCM
          </div>

          <div className='w-full md:w-max ml-1 mr-10 md:mx-4 block-520 hidden md:block'>
            {combineSearchBar}
          </div>
        </div>
      </div>
