...
import {LoginForm, RegisterForm, Modal, SiteLogo, ScrollToTopLink} from '../reuseable/'
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
        ...
        <div className="flex md:pl-64 xl:pr-16 items-center justify-between gap-4 p-2">
          ...
          <div className="flex gap-2">
            <ScrollToTopLink to ="/cart"
              className="flex bg-white border-2 duration-300 border-gray-200 justify-center items-center p-2 px-2.5 text-black rounded-full hover:bg-gray-200 transition text-nowrap relative"
            >
              <FaCartPlus /> <div className='rounded-full px-1.5 bg-red-600 flex justify-center items-center absolute bottom-0 right-0 text-sm text-white' style={{transform: "translate(30%, 25%)"}}>
                  3
              </div>
            </ScrollToTopLink>
        ...
        {/* Bottom bar*/}
        <div className="border-b border-gray-300 bg-white p-2 flex items-center md:justify-between z-50 xl:pr-12">
